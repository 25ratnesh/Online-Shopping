...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="category1">
        <h1 style = "font-family: 'Edu QLD Beginner', cursive;font-family: 'Pacifico', cursive; text-align:center">Womens</h1>
          ...
          <div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:productdb %>" SelectCommand="SELECT [ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] where CategoryID='3'"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
