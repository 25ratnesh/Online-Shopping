        ...
        <div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:productdb %>" SelectCommand="SELECT TOP 3[ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] ORDER BY ProductID desc"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:productdb %>" SelectCommand="SELECT TOP 3[ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] where CategoryID='1'"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
...
<div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:productdb %>" SelectCommand="SELECT TOP 3 [ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] where CategoryID='2'"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="jumbotron">
            <div class="container">
                <div class="row">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:productdb %>" SelectCommand="SELECT TOP 3 [ProductID], [ProductName], [ProductPrice], [ProductImage] FROM [ProductDatabase] where CategoryID='5'"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
